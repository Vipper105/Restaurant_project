						...
						<ul>
							...
							<li class="dropdown" onclick="show_hide('s1')"><a href="#/">Pages
								...
								<div class="drop-content" id="s1">
									<a href="/webShop/reservation-page">Reservation</a> <a
										href="stuff.html">Stuff</a> <a href="gallery.html">Gallery</a>
								</div></li>
							<li class="dropdown" onclick="show_hide('s2')"><a href="#/">Blog
									&#9660;</a>
								<div class="drop-content" id="s2">
									<a href="blog.html">blog</a> <a
										href="/webShop/blog-details-page">blog Single</a>
								</div></li>
	...
	<div class="pc-layout">
		...
		<div class="gallery-content">
			...
			<div class="gallary-image" onmouseover="bigImg('gm<%=i %>')"
				...
				<a href="<%=contextPath%>/<%=listMenu.get(i).getIntro() %>">
				<img src="<%=contextPath%>/<%=listMenu.get(i).getIntro() %>" alt="Gallery Images" class="img-gl" id="gm<%=i %>">
				</a>
